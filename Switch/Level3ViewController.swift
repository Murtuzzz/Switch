...
class Level3ViewController: UIViewController {
    ...
    private var correctCombination: [Bool] = [true, false, true, false]
    ...
    private func animateSuccess() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                let level4VC = Level4ViewController()
                level4VC.modalPresentationStyle = .fullScreen
                self.present(level4VC, animated: true)
            }
        }
    }
