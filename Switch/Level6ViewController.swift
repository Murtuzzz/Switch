...
class Level6ViewController: UIViewController {
    ...
    private var targetValues: [Float] = [0.25, 0.75]
    private var tolerance: Float = 0.05
    ...
    private func setupUI() {
        ...
        levelLabel.text = LocalizationManager.Levels.level6.localized
    ...
    private func animateSuccess() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                let level7VC = Level7ViewController()
                level7VC.modalPresentationStyle = .fullScreen
                self.present(level7VC, animated: true)
            }
        }
    }
    
    private func resetSliders() {
        sliders.forEach { $0.value = 0.5 }
