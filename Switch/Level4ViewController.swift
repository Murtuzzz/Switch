...
class Level4ViewController: UIViewController {
    ...
    private var correctCombination: [Bool] = [false, true, false, true, false]
    ...
    private func createSwitches() {
        ...
        NSLayoutConstraint.activate([
            stackView.centerXAnchor.constraint(equalTo: containerView.centerXAnchor),
            stackView.centerYAnchor.constraint(equalTo: containerView.centerYAnchor, constant: 16)
        ])
    }
    ...
    private func animateSuccess() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                let level5VC = Level5ViewController()
                level5VC.modalPresentationStyle = .fullScreen
                self.present(level5VC, animated: true)
            }
        }
    }
