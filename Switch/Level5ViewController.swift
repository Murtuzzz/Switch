...
class Level5ViewController: UIViewController {
    ...
    private var correctCombination: [Bool] = [true, false, true, false, true, false]
    ...
    private func setupUI() {
        ...
        levelLabel.text = LocalizationManager.Levels.level5.localized
    ...
    private func createSwitches() {
        ...
        for _ in 0..<6 {
            ...
            mySwitch.transform = CGAffineTransform(scaleX: 1.4, y: 1.4)
        ...
        NSLayoutConstraint.activate([
            stackView.centerXAnchor.constraint(equalTo: containerView.centerXAnchor),
            stackView.centerYAnchor.constraint(equalTo: containerView.centerYAnchor, constant: 24)
        ])
    }
...
//            } completion: { _ in
//                let alert = UIAlertController(title: "Поздравляем!", message: "Вы прошли все уровни!", preferredStyle: .alert)
...
//        }
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                let level6VC = Level6ViewController()
                level6VC.modalPresentationStyle = .fullScreen
                self.present(level6VC, animated: true)
            }
        }
    }
