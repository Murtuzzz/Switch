...
class Level1ViewController: UIViewController {
    ...
    private var correctCombination: [Bool] = [true, false]
    ...
    private func setupUI() {
        ...
        levelLabel.text = LocalizationManager.Levels.level1.localized
    ...
    private func animateSuccess() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                let level2VC = Level2ViewController()
                level2VC.modalPresentationStyle = .fullScreen
                self.present(level2VC, animated: true)
            }
        }
    }
